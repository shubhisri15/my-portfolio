...
export default function CaseStudyHeader({ product, timeline, role }: CaseStudyHeaderProps) {
    return (
        <section className='bg-[#1E2E54] flex items-start justify-between rounded-lg my-8'>
            <div className='flex flex-col items-center text-center gap-4 p-8 border-r-1 border-slate-600'>
