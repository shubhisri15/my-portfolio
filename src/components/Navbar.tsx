    ...
    return (
        <>
            <nav className='z-1000 flex justify-between shadow-md w-full py-4 md:px-48 px-4 items-center fixed top-0 bg-slate-950 text-slate-300'>
                ...
                <a href='/Shubhi_Srivastava_Resume.pdf' download target='_blank' className='bg-gray-300 hover:bg-slate-300 text-slate-800 font-bold px-4 py-2 rounded-sm cursor-pointer'>RESUME</a>
